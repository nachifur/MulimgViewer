...
class IndexTableGui (wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Index Table", pos=wx.DefaultPosition,
        ...
        self.m_search_txt = wx.SearchCtrl(
        ...
        wSizer1.Add(self.m_search_txt, 0, wx.ALL |
                    wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.b_last_txt = wx.Button(
        ...
        self.index_table = wx.richtext.RichTextCtrl(
            self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(-1, -1), 0 | wx.HSCROLL | wx.VSCROLL | wx.WANTS_CHARS)
