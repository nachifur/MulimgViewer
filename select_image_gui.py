...
class SelectImgFrameGui (wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Mulimg viewer", pos=wx.DefaultPosition, size=wx.Size(
            950, 445), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.m_staticText1 = wx.StaticText(
            self.m_panel1, wx.ID_ANY, u"Control", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText1.Wrap(-1)

        bSizer1_1.Add(self.m_staticText1, 0, wx.ALL, 5)

        self.m_button1 = wx.Button(
            self.m_panel1, wx.ID_ANY, u"Next", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer1_1.Add(self.m_button1, 0, wx.ALL, 5)

        self.m_button2 = wx.Button(
            self.m_panel1, wx.ID_ANY, u"Last", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer1_1.Add(self.m_button2, 0, wx.ALL, 5)

        self.m_button3 = wx.Button(
            self.m_panel1, wx.ID_ANY, u"Save", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_slider1 = wx.Slider(
            self.m_panel1, wx.ID_ANY, 0, 0, 100, wx.DefaultPosition, wx.Size(215, -1), 0)
        bSizer1_2.Add(self.m_slider1, 0, wx.ALL, 5)

        self.slider_value = wx.StaticText(
            self.m_panel1, wx.ID_ANY, u"0", wx.DefaultPosition, wx.DefaultSize, 0)
        self.slider_value.Wrap(-1)

        bSizer1_2.Add(self.slider_value, 0, wx.ALL, 5)

        self.m_button4 = wx.Button(
            self.m_panel1, wx.ID_ANY, u"refresh", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        gbSizer1.Add(self.m_panel1, wx.GBPosition(0, 0),
        ...
        wSizer2.SetMinSize(wx.Size(600, -1))
        fgSizer2 = wx.FlexGridSizer(0, 1, 0, 0)
        fgSizer2.SetFlexibleDirection(wx.BOTH)
        fgSizer2.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_SPECIFIED)

        self.m_staticText3 = wx.StaticText(
            self.m_panel2, wx.ID_ANY, u"Setting", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText3.Wrap(-1)

        fgSizer2.Add(self.m_staticText3, 0, wx.ALL, 5)

        m_choice1Choices = [u"Each img", u"Stitch img", u"Each + Stitch"]
        self.m_choice1 = wx.Choice(self.m_panel2, wx.ID_ANY, wx.DefaultPosition, wx.Size(
            120, -1), m_choice1Choices, 0)
        self.m_choice1.SetSelection(0)
        fgSizer2.Add(self.m_choice1, 0, wx.ALL, 5)

        self.auto_save_all = wx.CheckBox(
            self.m_panel2, wx.ID_ANY, u"Auto save all !", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText8 = wx.StaticText(
            self.m_panel2, wx.ID_ANY, u"num per row", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText8.Wrap(-1)

        fgSizer3.Add(self.m_staticText8, 0, wx.ALL, 5)

        self.img_num_per_row = wx.TextCtrl(
            self.m_panel2, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0)
        fgSizer3.Add(self.img_num_per_row, 0, wx.ALL, 5)

        self.checkBox_orientation = wx.CheckBox(
            self.m_panel2, wx.ID_ANY, u"Vertical", wx.DefaultPosition, wx.Size(-1, -1), 0)
        ...
        self.m_staticText6 = wx.StaticText(
            self.m_panel2, wx.ID_ANY, u"num per img", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText6.Wrap(-1)

        fgSizer4.Add(self.m_staticText6, 0, wx.ALL, 5)

        self.num_per_img = wx.TextCtrl(
            self.m_panel2, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(-1, -1), 0)
        fgSizer4.Add(self.num_per_img, 0, wx.ALL, 5)

        self.auto_layout = wx.CheckBox(
            self.m_panel2, wx.ID_ANY, u"Auto layout", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText5 = wx.StaticText(
            self.m_panel2, wx.ID_ANY, u"num per column", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText5.Wrap(-1)

        fgSizer5.Add(self.m_staticText5, 0, wx.ALL, 5)

        self.img_num_per_column = wx.TextCtrl(
            self.m_panel2, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(-1, -1), 0)
        fgSizer5.Add(self.img_num_per_column, 0, wx.ALL, 5)

        self.m_colourPicker1 = wx.ColourPickerCtrl(
            self.m_panel2, wx.ID_ANY, wx.BLACK, wx.DefaultPosition, wx.DefaultSize, wx.CLRP_DEFAULT_STYLE)
        ...
        self.m_staticText81 = wx.StaticText(
            self.m_panel2, wx.ID_ANY, u"gap(pixel)", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText81.Wrap(-1)

        fgSizer6.Add(self.m_staticText81, 0, wx.ALL, 5)

        self.gap = wx.TextCtrl(self.m_panel2, wx.ID_ANY,
                               u"5", wx.DefaultPosition, wx.DefaultSize, 0)
        fgSizer6.Add(self.gap, 0, wx.ALL, 5)

        self.m_staticText9 = wx.StaticText(
            self.m_panel2, wx.ID_ANY, u"Gap fill color", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        gbSizer1.Add(self.m_panel2, wx.GBPosition(0, 3),
                     wx.GBSpan(1, 1), wx.EXPAND | wx.ALL, 5)

        fgSizer1.Add(gbSizer1, 1, wx.EXPAND, 5)

        self.m_staticText7 = wx.StaticText(
            self, wx.ID_ANY, u"Image show area", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText7.Wrap(-1)

        fgSizer1.Add(self.m_staticText7, 0, wx.ALL, 5)

        self.m_scrolledWindow1 = wx.ScrolledWindow(
            self, wx.ID_ANY, wx.DefaultPosition, wx.Size(100, 100), wx.HSCROLL | wx.VSCROLL)
        ...
        self.m_menuItem1 = wx.MenuItem(
            self.m_menu21, wx.ID_ANY, u"Auto", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu21.Append(self.m_menuItem1)

        self.m_menuItem2 = wx.MenuItem(
            self.m_menu21, wx.ID_ANY, u"manual", wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.m_menuItem3 = wx.MenuItem(
            self.m_menu1, wx.ID_ANY, u"One dir mul img", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu1.Append(self.m_menuItem3)

        self.MyMenu.AppendSubMenu(self.m_menu1, u"Input path")

        self.m_menuItem4 = wx.MenuItem(
            self.MyMenu, wx.ID_ANY, u"Out path", wx.EmptyString, wx.ITEM_NORMAL)
        self.MyMenu.Append(self.m_menuItem4)

        self.m_menubar1.Append(self.MyMenu, u"File")

        self.m_menu2 = wx.Menu()
        self.menu_next = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, u"Next\tCtrl+N", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu2.Append(self.menu_next)

        self.menu_last = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, u"Last\tCtrl+L", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu2.Append(self.menu_last)

        self.menu_save = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, u"Save\tCtrl+S", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu2.Append(self.menu_save)

        self.menu_up = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, u"Up", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu2.Append(self.menu_up)

        self.menu_down = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, u"Down", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu2.Append(self.menu_down)

        self.menu_right = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, u"Right", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu2.Append(self.menu_right)

        self.menu_left = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, u"left", wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.menu_about = wx.MenuItem(
            self.m_menu3, wx.ID_ANY, u"About", wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.m_colourPicker1.Bind(
            wx.EVT_COLOURPICKER_CHANGED, self.colour_change)
        self.Bind(wx.EVT_MENU, self.one_dir_mul_dir_auto,
                  id=self.m_menuItem1.GetId())
        self.Bind(wx.EVT_MENU, self.one_dir_mul_dir_manual,
                  id=self.m_menuItem2.GetId())
        self.Bind(wx.EVT_MENU, self.one_dir_mul_img,
                  id=self.m_menuItem3.GetId())
