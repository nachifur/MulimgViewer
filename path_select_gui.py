...
class PathSelectFrameGui (wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Parallel manual choose input directory",
        ...
        self.button_clear_all = wx.Button(
            self, wx.ID_ANY, u"Clear all path", wx.DefaultPosition, wx.DefaultSize, 0)
        utton_clear_last.Add(self.button_clear_all, 0, wx.ALL, 5)

        self.button_clear_last = wx.Button(
            self, wx.ID_ANY, u"Clear last path ", wx.DefaultPosition, wx.DefaultSize, 0)
        utton_clear_last.Add(self.button_clear_last, 0, wx.ALL, 5)

        fgSizer1.Add(utton_clear_last, 1, wx.EXPAND, 5)

        self.m_richText1 = wx.richtext.RichTextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(
            -1, 300), 0 | wx.VSCROLL | wx.HSCROLL | wx.NO_BORDER | wx.WANTS_CHARS)
        ...
        self.m_menuItem1 = wx.MenuItem(
            self.m_menu1, wx.ID_ANY, u"Clear all path" + u"\t" + u"CTRL+A", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu1.Append(self.m_menuItem1)

        self.m_menuItem2 = wx.MenuItem(
            self.m_menu1, wx.ID_ANY, u"Clear last path" + u"\t" + u"CTRL+Z", wx.EmptyString, wx.ITEM_NORMAL)
        self.m_menu1.Append(self.m_menuItem2)

        self.menu_close = wx.MenuItem(
            self.m_menu1, wx.ID_ANY, u"Close" + u"\t" + u"Alt+C", wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.Bind(wx.EVT_MENU, self.clear_all_path,
                  id=self.m_menuItem1.GetId())
        self.Bind(wx.EVT_MENU, self.clear_last_path,
